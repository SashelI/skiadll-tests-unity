...
namespace Dummiesman 
{
    public static class OBJLoaderHelper  
    {
        ...
        public static Material CreateDefaultMaterial(string name = null)
        {
            return new Material(Shader.Find("Standard (Specular setup)")) { name = name };
            //return new Material(Shader.Find("Mixed Reality Toolkit/Standard")){ name = name };
        }
